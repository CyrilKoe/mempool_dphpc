...
- `hardware` is the folder where to run RTL simulations
- `jupyter` contains the notebooks and python scripts to process result datas
- `software`
    * `onnx` contains the C codes used to run
