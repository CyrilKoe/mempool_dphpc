    ...
    for files in os.listdir(path):
        if files.endswith(ext):
            ...
            for section in set(csvread['section']):
                ...
                cycles[section] = max
            df_tmp = pd.DataFrame(cycles, index=['seq', 'man1', 'man2', 'man3', 'man4', 'man_amo', 'seq_simd', 'man1_simd', 'man2_simd', 'man3_simd', 'man4_simd', 'simd_atomic', 'omp_stat'], columns=[folders])
